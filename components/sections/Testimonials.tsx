...
export function Testimonials() {
  return (
    <section id="opiniones" className="home-section md:py-32">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-3 md:gap-6">
          {testimonials.map((t, index) => (
            <ScrollReveal key={t.id} delay={index * SCROLL_REVEAL_STAGGER_MS}>
              <blockquote className="flex h-full flex-col rounded-2xl glass-card p-8 transition-all duration-500 hover:border-white/15">
