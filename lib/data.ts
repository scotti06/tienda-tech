...
export const products: Product[] = [
  {
    ...
    tags: ["iPhone 15", "iPhone 14", "funda", "silicone"],
  },
  {
    id: "2",
  ...
  },
  {
    ...
    rating: 0,
    description: "Protección de pantalla resistente. Consultá medida según modelo.",
    tags: ["vidrio templado", "iPhone 15", "Samsung S24", "pantalla"],
  },
  {
    id: "4",
    ...
    rating: 0,
    description: "Pack promocional de dos unidades. Consultá compatibilidad.",
    tags: ["vidrio templado", "pack", "iPhone"],
  },
  {
    id: "5",
    ...
    rating: 0,
    description: "Carga rápida original Apple. Ideal para iPhone y accesorios USB-C.",
    tags: ["cargador", "Apple", "20W", "USB-C", "iPhone 15"],
  },
  {
    id: "6",
    ...
    rating: 0,
    description: "Cargador certificado Apple. Consultá variantes según tu modelo.",
    tags: ["cargador", "Apple", "iPhone", "original"],
  },
  {
    id: "7",
    slug: "airpods",
    ...
    rating: 0,
    description: "Auriculares inalámbricos Apple. Consultá stock y generación.",
    tags: ["AirPods", "auriculares", "Apple", "bluetooth"],
  },
  {
    id: "8",
    slug: "airpods-pro",
    ...
    rating: 0,
    description: "Cancelación activa de ruido y audio premium. Consultá disponibilidad.",
    tags: ["AirPods Pro", "auriculares", "Apple", "Pro"],
  },
  {
    id: "9",
    slug: "consola-gaming",
    name: "Consola de gaming",
    category: "Consolas y Gaming",
    categoryId: "consolas",
    price: 0,
    accent: "bg-[radial-gradient(ellipse_at_50%_0%,#1a1a2e_0%,#0a0c10_70%)]",
    image: "/categories/airpods.webp",
    imageFrame: { width: 240, height: 200 },
    rating: 0,
    description: "Consolas y accesorios gaming. Consultá modelos y stock.",
    tags: ["consola", "gaming", "PlayStation", "Xbox", "Nintendo"],
  },
  {
    id: "10",
    ...
    price: 0,
    accent: "bg-[radial-gradient(ellipse_at_50%_0%,#152030_0%,#0a0c10_70%)]",
    image: "/categories/carga.webp",
    imageFrame: { width: 220, height: 220 },
    rating: 0,
    description: "Parlantes portátiles con conexión inalámbrica. Consultá modelos.",
    tags: ["parlante", "bluetooth", "audio", "portátil"],
  },
  {
    id: "11",
    slug: "apple-watch",
    ...
    rating: 0,
    description: "Relojes Apple Watch. Consultá series y tamaños disponibles.",
    tags: ["Apple Watch", "reloj", "smartwatch", "Series 9"],
  },
  {
    id: "12",
    slug: "tv-stick",
    ...
    categoryId: "tv-stick",
    price: 0,
    accent: "bg-[radial-gradient(ellipse_at_50%_0%,#1a1828_0%,#0a0c10_70%)]",
    image: "/categories/vidrios.webp",
    imageFrame: { width: 260, height: 180 },
    rating: 0,
    description: "Convertí tu TV en smart con streaming. Consultá modelos.",
    tags: ["TV Stick", "streaming", "Chromecast", "Fire Stick", "smart TV"],
  },
  {
    id: "13",
    slug: "tv-box",
    ...
    categoryId: "tv-box",
    price: 0,
    accent: "bg-[radial-gradient(ellipse_at_50%_0%,#201828_0%,#0a0c10_70%)]",
    image: "/categories/fundas.webp",
    imageFrame: { width: 260, height: 180 },
    rating: 0,
    description: "TV Box con Android para apps y contenido. Consultá stock.",
    tags: ["TV Box", "Android", "streaming", "4K"],
  },
  {
    id: "14",
    slug: "termo-acero",
    ...
    categoryId: "termos",
    price: 0,
    accent: "bg-[radial-gradient(ellipse_at_50%_0%,#1a2420_0%,#0a0c10_70%)]",
    image: "/products/cargador-apple-20w.webp",
    imageFrame: { width: 200, height: 260 },
    rating: 0,
    description: "Termos térmicos de acero inoxidable. Consultá capacidades.",
    tags: ["termo", "acero", "térmico", "hogar"],
  },
  {
    id: "15",
    slug: "vaso-termico",
    ...
    categoryId: "vasos",
    price: 0,
    accent: "bg-[radial-gradient(ellipse_at_50%_0%,#182028_0%,#0a0c10_70%)]",
    image: "/products/vidrio-templado-pack.webp",
    imageFrame: { width: 200, height: 240 },
    rating: 0,
    description: "Vasos térmicos para bebidas frías o calientes. Consultá modelos.",
    tags: ["vaso", "térmico", "hogar", "Stanley"],
  },
];
